...
class Pagemobelhome{
    ...
    public function show() {
        ...
        if($up_page == ''){
            $down_page = ($down_row <= $this->totalPages) ? '<li><a class="next first" href="' . $this->url($down_row) . '">' . $this->config['next'] . '</a></li>' : '';
        }else{
        ...
        // 覆盖上一页
        if($down_page == ''){
            $up_page = $up_row > 0 ? '<li><a class="prev first" href="' . $this->url($up_row) . '">' . $this->config['prev'] . '</a></li>' : '';
        }else{
            $up_page = $up_row > 0 ? '<li><a class="prev" href="' . $this->url($up_row) . '">' . $this->config['prev'] . '</a></li>' : '';
        }
