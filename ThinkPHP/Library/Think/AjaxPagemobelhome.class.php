...
class AjaxPagemobelhome{
    ...
    public function show() {
        ...
        if($up_page == ''){
            $down_page = ($down_row <= $this->totalPages) ? '<li><a class="next first" page-id="'.$down_row.'" href="javascript:void(0);">' . $this->config['next'] . '</a></li>' : '';
        }else{
        ...
        // 覆盖上一页
        if($down_page == ''){
            $up_page = $up_row > 0 ? '<li><a class="prev first" page-id="'.$up_row.'" href="javascript:void(0);">' . $this->config['prev'] . '</a></li>' : '';
        }else{
            $up_page = $up_row > 0 ? '<li><a class="prev" page-id="'.$up_row.'" href="javascript:void(0);">' . $this->config['prev'] . '</a></li>' : '';
        }
